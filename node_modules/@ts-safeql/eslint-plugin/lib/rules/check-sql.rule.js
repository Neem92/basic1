...
exports.RuleOptions = exports.Options = exports.UserConfigFile = exports.Config = exports.connectByMigrationSchema = void 0;
...
exports.connectByMigrationSchema = zod_1.default.object({
    /**
...
const RuleOptionConnection = zod_1.default.union([
    baseSchema.merge(exports.connectByMigrationSchema.merge(identifyByNameAndOperators)),
    baseSchema.merge(exports.connectByMigrationSchema.merge(identifyByTagName)),
