...
export declare function isWatchMigrationsDirEnabled(connection: RuleOptionConnection): connection is RuleOptionConnection & z.infer<typeof connectByMigrationSchema> & {
    watchMode: true;
};
